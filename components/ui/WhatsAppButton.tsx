...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`group fixed z-[100] flex h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-black/80 text-white shadow-2xl backdrop-blur-md transition-[color,background-color,border-color,box-shadow,transform] focus-visible:ring-2 focus-visible:ring-[var(--accent-cyan)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-base)] ${shouldReduceMotion ? '' : 'whatsapp-fab'}`}
      style={{
    ...
    >
        ...
        xmlns="http://www.w3.org/2000/svg"
          className="transition-colors group-hover:text-[var(--accent-cyan)]"
          aria-hidden="true"
        >
